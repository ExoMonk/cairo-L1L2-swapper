...
@external
func swap_token_message{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
@external
func update_l1_contrat{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    new_l1_address: felt
) {
